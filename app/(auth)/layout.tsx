...
const AuthLayout = ({ children }: { children: ReactNode }) => {
  return (
    <main className="flex-between min-h-screen items-center justify-center w-full bg-auth-light dark:bg-auth-dark bg-cover bg-center bg-no-repeat px-4 py-10">
