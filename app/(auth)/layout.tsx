...
const AuthLayout = ({ children }: { children: ReactNode }) => {
  return (
    <main className="flex-between bg-auth-light dark:bg-auth-dark min-h-screen w-full items-center justify-center bg-cover bg-center bg-no-repeat px-4 py-10">
